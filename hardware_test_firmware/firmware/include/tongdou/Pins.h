...
constexpr gpio_num_t I2C_SDA = GPIO_NUM_5;
constexpr gpio_num_t I2C_SCL = GPIO_NUM_6;
...
constexpr gpio_num_t WS2812_DATA = GPIO_NUM_9;
...
constexpr gpio_num_t RADAR_OUT = GPIO_NUM_7;
